...
ALTER TABLE t_sak_bairro ADD CONSTRAINT pk_bairro PRIMARY KEY ( cd_bairro );
...
ALTER TABLE t_sak_cidade ADD CONSTRAINT pk_cidade PRIMARY KEY ( cd_cidade );
...
ALTER TABLE t_sak_endereco ADD CONSTRAINT pk_endereco_correio PRIMARY KEY ( cd_end_correio );
...
ALTER TABLE t_sak_estado ADD CONSTRAINT pk_estado PRIMARY KEY ( cd_estado );
...
ALTER TABLE t_sak_funcionario_endereco ADD CONSTRAINT pk_funcionario_endereco PRIMARY KEY ( cd_end_func,
                                                                                            cd_func );
...
ALTER TABLE t_sak_projeto ADD CONSTRAINT pk_ska_projeto PRIMARY KEY ( cd_projeto );

ALTER TABLE t_sak_projeto ADD CONSTRAINT un_ska_projeto_nome UNIQUE ( nm_projeto );
...
ALTER TABLE t_sak_tipo_endereco ADD CONSTRAINT pk_tipo_endereco PRIMARY KEY ( cd_tipo_endereco );
...
ALTER TABLE t_sak_funcionario_endereco
    ADD CONSTRAINT fk_end_correio_func FOREIGN KEY ( cd_end_correio )
...
ALTER TABLE t_sak_funcionario_endereco
    ADD CONSTRAINT fk_func_endereco FOREIGN KEY ( cd_func )
        REFERENCES t_sak_funcionario ( cd_func );

ALTER TABLE t_sak_execucao_proj
    ADD CONSTRAINT fk_func_exec_projeto FOREIGN KEY ( cd_func )
        REFERENCES t_sak_funcionario ( cd_func );

ALTER TABLE t_sak_telefone
    ADD CONSTRAINT fk_func_telefone FOREIGN KEY ( cd_func )
        REFERENCES t_sak_funcionario ( cd_func );

ALTER TABLE t_sak_execucao_proj
    ADD CONSTRAINT fk_proj_execucao_proj FOREIGN KEY ( cd_projeto )
        REFERENCES t_sak_projeto ( cd_projeto );

ALTER TABLE t_sak_funcionario_endereco
    ADD CONSTRAINT fk_tipo_endereco FOREIGN KEY ( cd_tipo_endereco )
